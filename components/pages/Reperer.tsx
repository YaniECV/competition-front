          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              {tab.renvoiZones.map(z => (
                <Link key={z} href={`/accessible/mise-en-place?zone=${z}`} style={{ fontSize: 11, fontFamily: 'var(--font-mono)', border: '1px solid var(--border)', padding: '4px 10px', color: 'var(--muted)', textDecoration: 'none' }}>
                  Zone {zoneLabels[z]} →
                </Link>
              ))}
              <Link href="/ressources/signaletiques" style={{ fontSize: 11, fontFamily: 'var(--font-mono)', border: '1px solid var(--border)', padding: '4px 10px', color: 'var(--muted)', textDecoration: 'none' }}>
                Signalétiques →
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              {tab.renvoiZones.map(z => (
                <Link
                  key={z}
                  href={`/accessible/mise-en-place?zone=${z}`}
