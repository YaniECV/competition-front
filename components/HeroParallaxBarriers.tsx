...
export default function HeroParallaxBarriers() {
  ...
  return (
    <>
      {/* Barrier gauche */}
      <div ref={leftRef} style={{ position: 'absolute', left: -53, top: '58%', width: 480, height: 394, pointerEvents: 'none', willChange: 'transform' }}>
      ...
      {/* Barrier droite */}
      <div ref={rightRef} style={{ position: 'absolute', right: -105, top: '18%', width: 482, height: 400, pointerEvents: 'none', willChange: 'transform' }}>
